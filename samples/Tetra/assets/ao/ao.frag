...
const int	kNumSamples		= 15; //9; // Use these higher values on fast GPUs
const int	kNumSpiralTurns	= 7; //5; // Use prime numbers so the same texel is never sampled twice
const float	kStrength		= 2.35;
